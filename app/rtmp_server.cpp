...
#define TEST_RTMP_PUSHER  0
#define TEST_RTMP_CLIENT  1
#define TEST_MULTI_THREAD 1
#define RTMP_URL    "rtmp://127.0.0.1:1935/live/02"
#define PUSH_FILE   "./test.h264"
#define HTTP_URL    "http://127.0.0.1:8080/live/02.flv"
